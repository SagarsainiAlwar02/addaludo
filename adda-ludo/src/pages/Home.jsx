...
export default function Home() {
  ...
  return (
    <div className="page-container pt-1 relative min-h-screen pb-32">
      ...
      {/* FIXED CLEAN WHATSAPP SUPPORT BUTTON (No extra glow, aligned perfectly above navbar) */}
      <div 
      ...
      >
        {/* Main WhatsApp Icon - Clean Circle */}
        <div className="bg-[#25D366] w-12 h-12 rounded-full shadow-md flex items-center justify-center border border-white/40">
          <svg 
        ...
        {/* Clean Support Label */}
        <span className="text-[10px] font-bold text-white bg-black/80 px-2 py-0.5 rounded shadow-sm mt-1 uppercase tracking-wider font-sans">
          Support
        </span>
      </div>
    </div>
