...
export default function Home() {
  ...
  return (
    <div className="page-container pt-1 relative min-h-screen pb-32">
      ...
      {/* FIXED WHATSAPP SUPPORT BUTTON WITH DIRECT LIVE URL */}
      <div 
      ...
      >
        {/* Direct WhatsApp Image Link */}
        <div className="w-12 h-12 flex items-center justify-center filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)]">
          <img 
