        ...
        <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-4">
          ...
          <div className="w-full overflow-hidden flex justify-center items-center py-4 bg-amber-50/50 rounded-xl mb-4">
            <img
              ...
              onError={(e) => {
                e.target.src = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='100' height='50' viewBox='0 0 100 50'><rect width='100%' height='100%' fill='%23eff6ff'/><text x='50%' y='50%' dominant-baseline='middle' text-anchor='middle' font-family='sans-serif' font-weight='bold' font-size='5' fill='%233b82f6'>Gift Commission</text></svg>";
              }}
            />
          </div>
