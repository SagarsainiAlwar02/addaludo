...
const FAKE_RUNNING_BATTLES = [
  { battleId: "fake_run_1", amount: 10000, prize: calculatePrizeAmount(10000), status: "running", isFake: true, createdBy: { name: "Rahul" }, opponent: { name: "Vikas" } },

  { battleId: "fake_run_2", amount: 8000, prize: calculatePrizeAmount(8000), status: "running", isFake: true, createdBy: { name: "Aman" }, opponent: { name: "Rohit" } },

  { battleId: "fake_run_3", amount: 6500, prize: calculatePrizeAmount(6500), status: "running", isFake: true, createdBy: { name: "Deepak" }, opponent: { name: "Sandeep" } },

  { battleId: "fake_run_4", amount: 5000, prize: calculatePrizeAmount(5000), status: "running", isFake: true, createdBy: { name: "Ankit" }, opponent: { name: "Kunal" } },

  { battleId: "fake_run_5", amount: 4500, prize: calculatePrizeAmount(4500), status: "running", isFake: true, createdBy: { name: "Rajat" }, opponent: { name: "Nitin" } },

  { battleId: "fake_run_6", amount: 4000, prize: calculatePrizeAmount(4000), status: "running", isFake: true, createdBy: { name: "Golu" }, opponent: { name: "Monu" } },

  { battleId: "fake_run_7", amount: 3500, prize: calculatePrizeAmount(3500), status: "running", isFake: true, createdBy: { name: "Sonu" }, opponent: { name: "Tinku" } },

  { battleId: "fake_run_8", amount: 3000, prize: calculatePrizeAmount(3000), status: "running", isFake: true, createdBy: { name: "Abhishek" }, opponent: { name: "Harsh" } },

  { battleId: "fake_run_9", amount: 2500, prize: calculatePrizeAmount(2500), status: "running", isFake: true, createdBy: { name: "Ajay" }, opponent: { name: "Pankaj" } },

  { battleId: "fake_run_10", amount: 2000, prize: calculatePrizeAmount(2000), status: "running", isFake: true, createdBy: { name: "Amit" }, opponent: { name: "Sachin" } },

  { battleId: "fake_run_11", amount: 1500, prize: calculatePrizeAmount(1500), status: "running", isFake: true, createdBy: { name: "Bhomla" }, opponent: { name: "Rakesh" } },

  { battleId: "fake_run_12", amount: 1000, prize: calculatePrizeAmount(1000), status: "running", isFake: true, createdBy: { name: "Yash" }, opponent: { name: "Arjun" } },

  { battleId: "fake_run_13", amount: 500, prize: calculatePrizeAmount(500), status: "running", isFake: true, createdBy: { name: "Lucky" }, opponent: { name: "Prince" } },

  { battleId: "fake_run_14", amount: 250, prize: calculatePrizeAmount(250), status: "running", isFake: true, createdBy: { name: "Shivam" }, opponent: { name: "Ritik" } },

  { battleId: "fake_run_15", amount: 100, prize: calculatePrizeAmount(100), status: "running", isFake: true, createdBy: { name: "Akash" }, opponent: { name: "Manish" } },

  { battleId: "fake_run_16", amount: 50, prize: calculatePrizeAmount(50), status: "running", isFake: true, createdBy: { name: "Ravi" }, opponent: { name: "Neeraj" } },
];
