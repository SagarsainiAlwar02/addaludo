...
export default function HeaderMain() {
  ...
  return (
    ...
    <header className="fixed top-0 left-0 right-0 z-40 w-full bg-gradient-to-r from-black via-[#050816] to-black shadow-lg border-b border-slate-800">
      <div className="mx-auto flex h-[50px] w-full max-w-[760px] items-center justify-between px-3 sm:h-[56px] sm:px-4">
        <div
          onClick={() => navigate("/")}
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={openAddCash}
            title="Add Cash"
            className="flex items-center gap-1 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 px-2.5 py-1 shadow-md shadow-cyan-500/20 active:scale-95 sm:gap-1.5 sm:px-3.5"
          >
            <i className="fa-solid fa-wallet text-[10px] text-white drop-shadow sm:text-xs"></i>
            <span className="text-[10px] font-extrabold text-white drop-shadow sm:text-xs">
              ₹ {balance}
            </span>
          </button>
          ...
          <button
            ...
            className="flex items-center gap-1 rounded-full border border-slate-600 bg-slate-800 px-2 py-1 shadow-md active:scale-95 sm:gap-1.5 sm:px-3"
          >
            <i className="fa-solid fa-list text-[10px] text-cyan-400 sm:text-xs"></i>
            <span className="text-[10px] font-extrabold text-white sm:text-xs">
              ₹ {referBalance}
            </span>
          </button>
