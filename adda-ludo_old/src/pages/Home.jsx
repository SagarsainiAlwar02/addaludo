...
export default function Home({ user }) {
  ...
  return (
    <div className="page-container pt-1 relative min-h-screen pb-36">
      ...
      {/* NEW FASTEST WITHDRAWAL & SUPPORT BANNER (WITH GAPS & CURVED CORNERS) */}
      <div className="mt-4 mb-3 overflow-hidden rounded-2xl bg-gradient-to-r from-[#0d182e] via-[#102246] to-[#0a1122] p-3.5 shadow-lg border border-slate-700/50">
        <div className="flex items-center justify-between gap-2">
          ...
          {/* Badge Icon */}
          <div className="flex-shrink-0 flex items-center justify-center w-11 h-11 rounded-full border-2 border-yellow-400 bg-black/40 text-white shadow-inner">
            <div className="text-center leading-none">
              <span className="block text-sm font-black text-white leading-none">
                24
              </span>
              <span className="block text-[8px] font-bold text-yellow-400 uppercase tracking-tighter mt-0.5">
                Service
              </span>
            </div>
          </div>
      ...
      {/* LIVE ANIMATED WHATSAPP SUPPORT BUTTON - SHIFTED DOWNWARDS */}
      <div 
        onClick={() => navigate("/support")}
        className="fixed bottom-16 right-5 z-40 flex flex-col items-center cursor-pointer active:scale-90 transition-transform"
      >
        <div className="relative w-11 h-11 flex items-center justify-center">
          ...
          <div className="absolute bg-[#25D366] w-11 h-11 rounded-full shadow-lg flex items-center justify-center border border-white transition-transform duration-300 hover:scale-105">
            <svg 
        ...
        {/* Support Label */}
        <span className="text-[9px] font-bold text-white bg-black/80 px-1.5 py-0.5 rounded shadow-sm mt-0.5 uppercase tracking-wider font-sans whitespace-nowrap">
          Support
        </span>
      </div>
    </div>
